...
<div class="eakc-category-archive">
            ...
            <div class="eakc-hero-content">
                ...
                <p class="eakc-hero-description">
                    ...
                    if ($tag_description) {
                        ...
                        printf(__('Browse all articles tagged with "%s"', 'energy-alabama-kc'), esc_html($tag_name));
                    }
                    ?>
                </p>
                    ...
                    <form class="eakc-search-form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                        <div class="eakc-search-wrapper">
                            <input type="search" 
                                    ...
                                    placeholder="<?php printf(__('Search %s articles...', 'energy-alabama-kc'), esc_attr($tag_name)); ?>"
                                    value="<?php echo get_search_query(); ?>" 
                                    name="s" 
                                    autocomplete="off"
                                    aria-label="<?php printf(__('Search %s articles', 'energy-alabama-kc'), esc_attr($tag_name)); ?>">
                            <input type="hidden" name="post_type" value="kc_article">
                            <input type="hidden" name="kc_tag" value="<?php echo esc_attr($tag_slug); ?>">
    ...
    <section class="eakc-category-content">
        <div class="eakc-container">
            ...
            <div class="eakc-category-stats" style="text-align: center; margin-bottom: 40px; color: #6b7280;">
                ...
                printf(
                    _n('%d article tagged', '%d articles tagged', $total_posts, 'energy-alabama-kc'),
                    $total_posts
                );
                ?>
            </div>
            ...
            <div class="eakc-articles-grid" id="eakc-articles-container">
                ...
                <?php else : ?>
                    ...
                    <div class="eakc-no-articles">
                        ...
                        <p><?php printf(__('There are currently no articles tagged with "%s".', 'energy-alabama-kc'), esc_html($tag_name)); ?></p>
    ...
    <section class="eakc-related-categories">
        <div class="eakc-container">
            <h3><?php _e('Explore Other Tags', 'energy-alabama-kc'); ?></h3>
            
            <div class="eakc-tags-cloud">
                <?php
                    ...
                    <div class="eakc-tags-list">
                        <?php foreach ($all_tags as $tag) : ?>
                            <a href="<?php echo esc_url(get_term_link($tag)); ?>" class="eakc-tag">
                                ...
                                <span class="eakc-tag-count"><?php echo $tag->count; ?></span>
                            </a>
                        <?php endforeach; ?>
                    </div>
                <?php else : ?>
                    <p class="eakc-no-tags"><?php _e('No other tags available.', 'energy-alabama-kc'); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </section>
...
<script>
// Simple filtering functions for the tag page
