<?php
/**
 * Template for KC Category Archive
 *
...
$category_color = eakc_get_category_color($category_slug);
?>
...
<div class="eakc-category-archive">
            ...
            <div class="eakc-hero-content">
                ...
                <p class="eakc-hero-description">
                    ...
                    if ($category_description) {
                        ...
                        printf(__('Browse all articles in the %s category', 'energy-alabama-kc'), esc_html($category_name));
                    }
                    ?>
                </p>
                    ...
                    <form class="eakc-search-form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                        <div class="eakc-search-wrapper">
                            <input type="search" 
                                    ...
                                    placeholder="<?php printf(__('Search %s...', 'energy-alabama-kc'), esc_attr($category_name)); ?>"
                                    value="<?php echo get_search_query(); ?>" 
                                    name="s" 
                                    autocomplete="off"
                                    aria-label="<?php printf(__('Search %s', 'energy-alabama-kc'), esc_attr($category_name)); ?>">
                            <input type="hidden" name="post_type" value="kc_article">
                            <input type="hidden" name="kc_category" value="<?php echo esc_attr($category_slug); ?>">
    ...
    <section class="eakc-category-content">
        <div class="eakc-container">
            ...
            <div class="eakc-category-stats" style="text-align: center; margin-bottom: 40px; color: #6b7280;">
                ...
                printf(
                    _n('%d article available', '%d articles available', $total_posts, 'energy-alabama-kc'),
                    $total_posts
                );
                ?>
            </div>
            ...
            <div class="eakc-articles-grid" id="eakc-articles-container">
                ...
                <?php else : ?>
                    ...
                    <div class="eakc-no-articles">
                        ...
                        <p><?php printf(__('There are currently no articles in the %s category.', 'energy-alabama-kc'), esc_html($category_name)); ?></p>
    ...
    <section class="eakc-related-categories">
        <div class="eakc-container">
            <h3><?php _e('Explore Other Categories', 'energy-alabama-kc'); ?></h3>
            ...
            <div class="eakc-categories-grid">
                ...
                if ($all_categories && !is_wp_error($all_categories)) :
                    foreach ($all_categories as $category) :
                        $cat_color = eakc_get_category_color($category->slug);
                    ...
                    <div class="eakc-category-card" style="--category-color: <?php echo esc_attr($cat_color); ?>;">
                        <a href="<?php echo esc_url(get_term_link($category)); ?>">
                            <div class="eakc-category-card-icon">
                                <?php echo eakc_get_category_icon($category->slug); ?>
                            </div>
